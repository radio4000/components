...
export default class R4Favicon extends HTMLElement {
	...
	render() {
		const sizeSvg = this.sizes[this.size]
		if (sizeSvg) {
			this.innerHTML = sizeSvg
		} else {
			this.innerHTML = this.defaultSize
		}
	}
}

export {smallSvg as R4SvgSmall, mediumSvg as R4SvgMedium}
