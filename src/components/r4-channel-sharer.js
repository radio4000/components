...
template.innerHTML = `
			<form>
				<fieldset>
					...
					<input name="channel_url" type="url" disabled/>
				</fieldset>
				<fieldset>
					<label for="channel_iframe">Channel Iframe</label>
					<input name="channel_iframe" type="url" disabled/>
				</fieldset>
				<fieldset>
					<label for="channel_icon">Channel Icon</label>
					<input name="channel_icon" type="url" disabled/>
				</fieldset>
			</form>
		`
...
export default class R4ChannelSharer extends HTMLElement {
	...
	get apiOrigin() {
		return 'https://api.radio4000.com'
	}

	get iconOrigin() {
		return 'https://assets.radio4000.com/icon-r4.svg'
	}
